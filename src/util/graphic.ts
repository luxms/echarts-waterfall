...
import * as Path from "zrender/lib/graphic/Path";
// import * as Transformable from "zrender/lib/mixin/Transformable";
import * as ZImage from "zrender/lib/graphic/Image";
// import * as Group from "zrender/lib/container/Group";
import * as Text from "zrender/lib/graphic/Text";
import * as Circle from "zrender/lib/graphic/shape/Circle";
import * as Sector from "zrender/lib/graphic/shape/Sector";
import * as Ring from "zrender/lib/graphic/shape/Ring";
import * as Polygon from "zrender/lib/graphic/shape/Polygon";
import * as Polyline from "zrender/lib/graphic/shape/Polyline";
import * as Rect from "zrender/lib/graphic/shape/Rect";
import * as Line from "zrender/lib/graphic/shape/Line";
import * as BezierCurve from "zrender/lib/graphic/shape/BezierCurve";
import * as Arc from "zrender/lib/graphic/shape/Arc";
import * as CompoundPath from "zrender/lib/graphic/CompoundPath";
import * as LinearGradient from "zrender/lib/graphic/LinearGradient";
import * as RadialGradient from "zrender/lib/graphic/RadialGradient";
import * as BoundingRect from "zrender/lib/core/BoundingRect";
import * as IncrementalDisplayable from "zrender/lib/graphic/IncrementalDisplayable";
...
function setHoverStyle(el, hoverStyle, opt) {
  el.isGroup
    ? el.traverse(function (child) {
        ...
        !child.isGroup &&
          setElementHoverStyle(child, child.hoverStyle || hoverStyle);
      })
...
function setAsHighDownDispatcher(el, opt) {
  ...
  if (!disable || el.__highDownDispatcher) {
    ...
    el[method]("emphasis", onEnterEmphasisByAPI)[method](
      "normal",
      onEnterNormalByAPI
    );
...
function setTextStyleCommon(textStyle, textStyleModel, opt, isEmphasis) {
  ...
  if (opt.isRectText) {
    var textPosition =
      textStyleModel.getShallow("position") || (isEmphasis ? null : "inside"); // 'outside' is not a valid zr textPostion value, but used
...
export {
  ...
  setExtraHighDownEffect,
  removeExtraHighDownEffect,
  setHoverStyle,
